...
export default [
  ...
  { id: 0, name: "Mondopia", img: imgPlanet0, x: 70, y: 70 },
  { id: 1, name: "Zyrgon",   img: imgPlanet1, x: 32, y: 42 },
  { id: 2, name: "Ribos",    img: imgPlanet2, x: 8,  y: 3 },
  { id: 3, name: "Mustafar", img: imgPlanet3, x: 53, y: 16 },
  { id: 4, name: "Arrakis",  img: imgPlanet4, x: 82, y: 29 },
  { id: 5, name: "Kronos",   img: imgPlanet5, x: 94, y: 57 },
  { id: 6, name: "4546B",    img: imgPlanet6, x: 18, y: 78 },
